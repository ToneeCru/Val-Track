...
export default function VolunteerQRScan() {
    ...
    // Using mock patrons for demo purposes
    ...
    const fetchAttendanceData = async () => {
        ...
        try {
            // 1. Get counts for ALL areas in this branch
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#F8FAFC' }}>
            ...
            <div className="ml-64">
                <Topbar title="Patron QR Scan" subtitle="Volunteer Access" />
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 p-6 mb-8">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Tap to simulate scan in {selectedArea?.name || '...'}</p>
                                    </div>
                                </div>
