...
export default function AdminAuditLogs() {
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#F8FAFC' }}>
            ...
            <div className="ml-64">
                <Topbar title="Audit Logs" subtitle={branch ? `${branch.name} Activity Log` : 'Select a Branch'} />
                ...
                <main className="p-8">
                    {!branch ? (
                        <div className="flex flex-col items-center justify-center p-12 bg-white rounded-xl border border-dashed border-gray-300">
                            ...
                            <p className="text-gray-500 font-medium">Please select a branch to view audit logs.</p>
                        </div>
                    ) : (
                        <>
                            {/* Filters */}
